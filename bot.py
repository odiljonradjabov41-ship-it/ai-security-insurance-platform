...
# --- BOTNI ASYNC THREAD'DA ISHGA TUSHIRISH ---
...
app = FastAPI(
    ...
    version="5.0.0",
    lifespan=lifespan,
    docs_url=None,   # Standart docs o'chirildi, o'zimiz xavfsizini beramiz
    redoc_url=None
)
...
# --- CUSTOM SWAGGER UI ENDPOINT (CDNLAR TUZATILGAN) ---
